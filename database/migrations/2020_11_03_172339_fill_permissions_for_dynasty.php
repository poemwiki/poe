...
class FillPermissionsForDynasty extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDynasty constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dynasty',
            'admin.dynasty.index',
            'admin.dynasty.create',
            'admin.dynasty.show',
            'admin.dynasty.edit',
            'admin.dynasty.delete',
            'admin.dynasty.bulk-delete',
        ]);
