 ...
 * @method static authorHasImage(string $class, int $id)
 */
class Relatable extends MorphPivot {
    ...
    public const RELATION_RULES = [
        ...
        'author_has_avatar'          => ['start_type' => Author::class, 'end_type' => MediaFile::class, 'limit' => 1],
        'author_has_image'           => ['start_type' => Author::class, 'end_type' => MediaFile::class, 'limit' => 0]
    ];
    ...
    public function scopeAuthorHasImage($query, $startType, $startId) {
        $query->where([
