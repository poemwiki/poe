...
@section('content')
  ...
  <div class="changelog" style="width:100%; max-width:900px;">
    <h3>2025 年</h3>
    <ul>
      <li>🖼️ 优化：诗歌分享图片更清晰了。</li>
      <li>🐞 修复：删除诗歌后再次上传提示“已存在相同诗歌正文”。</li>
      <li>🗑️ 体验：在“我的原创”列表标题右侧新增删除按钮，点击后弹出确认框并可删除。</li>
      <li>🐞 修复：修复搜索功能中的排序和超时问题。</li>
      <li>✨ 新功能：支持添加与编辑作者别名。</li>
      <li>🖼️ 更新：诗歌分享图片显示更完整的信息，包含副标题、题记、译者、日期、地点。</li>
      <li>🐞 修复：修复推荐诗歌过于集中，容易重复的问题。</li>
      <li>✨ 新功能：用户页新增“我的五星”诗单，用于查看评过五星的诗歌。</li>
      <li>📘 更新 PoemWiki Open API 及其文档。</li>
      <li>🚀 体验：诗歌页与作者页加载速度提升。</li>
      <li>🎨 界面：图标与站点标识统一更新。</li>
      <li>🔐 账号与登录：恢复微信内浏览器内的微信登录功能。</li>
      <li>🔍 搜索与发现：在作者页添加了排序按钮，可切换最热/最新两种排序方式。</li>
      <li>🧭 可用性：错误提示页、加载中提示组件、滚动与导航细节打磨。</li>
      <li>📝 站点信息：在“关于诗歌维基”页面添加了更新日志。</li>
    </ul>
    <h3>2023-2024 年</h3>
    <ul>
      <li>🔍 搜索与浏览：搜索结果样式与布局调整，支持更精确的匹配与展示。</li>
      <li>🎯 活动：赛诗会活动增加配置能力（如更严格的行数/格式控制）。</li>
      <li>✨ 新功能：新增不同版本译作/原作对比页面。</li>
      <li>🗂️ 评分与内容：显示更清晰的综合评分（满足最少评分数后展现）。</li>
      <li>🏛 提案与协作：引入提案链接，方便社区跟进规划。</li>
    </ul>
    <h3>2022 年</h3>
    <ul>
      <li>🤝 用户贡献：显示并记录社区贡献。</li>
      <li>🗂️ 作者与作品信息：补充更多数据字段（生卒年、国家/朝代等）。</li>
    </ul>
    <h3>2021 年</h3>
    <ul>
      <li>✨ 新功能：4 月上线诗歌维基微信小程序。</li>
      <li>🔍 搜索与发现：可按作者关联检索诗歌。</li>
      <li>🗂️ 内容质量：新增原创/翻译标识。</li>
    </ul>
    <h3>2020 年</h3>
    <ul>
      <li>✨ 初始版本：7 月 21 日上线，包含作品与作者基础检索、上传与编辑、账号体系、头像与验证标识。</li>
    </ul>
  </div>
@endsection
