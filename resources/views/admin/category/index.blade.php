                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'describe_lang'">{{ trans('admin.category.columns.describe_lang') }}</th>
                                        ...
                                        <th is='sortable' :column="'name_lang'">{{ trans('admin.category.columns.name_lang') }}</th>
