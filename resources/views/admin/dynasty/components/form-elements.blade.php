    ...
    @foreach($locales as $locale)
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('describe_lang_{{ $locale }}'), 'has-success': fields['describe_lang_{{ $locale }}'] && fields['describe_lang_{{ $locale }}'].valid }">
                <label for="describe_lang_{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.dynasty.columns.describe_lang') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <input type="text" v-model="form.describe_lang['{{ $locale }}']" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('describe_lang_{{ $locale }}'), 'form-control-success': fields['describe_lang_{{ $locale }}'] && fields['describe_lang_{{ $locale }}'].valid }" id="describe_lang_{{ $locale }}" name="describe_lang_{{ $locale }}" placeholder="{{ trans('admin.dynasty.columns.describe_lang') }}">
    ...
    @foreach($locales as $locale)
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('name_lang_{{ $locale }}'), 'has-success': fields['name_lang_{{ $locale }}'] && fields['name_lang_{{ $locale }}'].valid }">
                <label for="name_lang_{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.dynasty.columns.name_lang') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <input type="text" v-model="form.name_lang['{{ $locale }}']" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('name_lang_{{ $locale }}'), 'form-control-success': fields['name_lang_{{ $locale }}'] && fields['name_lang_{{ $locale }}'].valid }" id="name_lang_{{ $locale }}" name="name_lang_{{ $locale }}" placeholder="{{ trans('admin.dynasty.columns.name_lang') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('f_id'), 'has-success': fields.f_id && fields.f_id.valid }">
    <label for="f_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.dynasty.columns.f_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.f_id" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('f_id'), 'form-control-success': fields.f_id && fields.f_id.valid}" id="f_id" name="f_id" placeholder="{{ trans('admin.dynasty.columns.f_id') }}">
        <div v-if="errors.has('f_id')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('f_id') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('name'), 'has-success': fields.name && fields.name.valid }">
    <label for="name" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.dynasty.columns.name') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.name" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('name'), 'form-control-success': fields.name && fields.name.valid}" id="name" name="name" placeholder="{{ trans('admin.dynasty.columns.name') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('wikidata_id'), 'has-success': fields.wikidata_id && fields.wikidata_id.valid }">
    <label for="wikidata_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.dynasty.columns.wikidata_id') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
