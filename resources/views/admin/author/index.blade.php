            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('/author/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.author.actions.create') }}</a>
                    </div>
