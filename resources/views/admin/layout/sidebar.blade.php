<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
           ...
           <li class="nav-item hidden"><a class="nav-link" href="{{ url('admin/tags') }}"><i class="nav-icon icon-drop"></i> {{ trans('admin.tag.title') }}</a></li>
           <li class="nav-item hidden"><a class="nav-link" href="{{ url('admin/categories') }}"><i class="nav-icon icon-globe"></i> {{ trans('admin.category.title') }}</a></li>
