...
<div>
    ...
    <section class="rate">
        {{--    <span class="left">@lang('score.rate & review')</span>--}}
        {{--    <svg class="stars">--}}
        {{--        <use href="#stars-o-5"/>--}}
        {{--    </svg>--}}
        <legend class="left">
    ...
    <svg class="hidden" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <symbol id="star" width="18" height="18" fill="#666" viewBox="0 0 1024 1024">
            <path
        ...
        <symbol id="star-o" width="12" height="12" fill="#666" viewBox="0 0 1024 1024">
            <path
