  ...
  <article class="poet page">
    ...
    @if(!empty($alias))
      <div class="poet-alias-wrapper mt-8 leading-loose flex items-baseline">
        ...
        <a title="@lang('Edit Aliases')"
          class="font-bold border-dotted border ml-4 w-10 h-10 leading-10 p-0 text-gray-400 text-center self-auto flex items-center justify-center"
