...
<div class="child">
  ...
  <a class="translated @if($isComparePage) compare-bg-{{array_search($poem->id, $idArr)}} @endif" href="{{$poem->url}}" @if($isTranslatedFrom) title="@lang('Translated from this version')" @endif>
    <dt>
